...
// If no question found, redirect back to index
if (!$questionFound) {
    header('Location: index.php');
    exit;
}

// NOW set the cookie after we know the question exists
setcookie($data["buttonName"], TRUE, time() + 31536000);
...
if ($isDailyDouble && (!isset($_COOKIE['current_wager']) || $_COOKIE['current_wager'] == '0')) {
    ...
    setcookie('pending_question_button', $data["buttonName"], time() + 31536000);
